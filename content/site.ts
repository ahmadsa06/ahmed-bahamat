  ...
  portfolio: {
    ...
    featured: [
      ...
      },
      {
        title: "Marj3",
        blurb:
          "Spaced-repetition learning for multi-disciplinary professionals — turns scattered material across several fields into scheduled reviews so it actually sticks.",
        decision: "Tuned for breadth across fields, not single-subject cramming.",
        status: "Built solo; live and iterating.",
        href: "https://marj3.ahmedbahamat.com",
      },
    ] as Project[],
    more: [
      { title: "AI telesales assistant", blurb: "Real-time call scripting + CRM.", href: "https://telesales.ahmedbahamat.com" },
      { title: "Rasad Time", blurb: "Remote attendance, no geo/IP/face-scan.", href: "https://rasd.ahmedbahamat.com" },
      { title: "Clubs Platform", blurb: "Kids'-club SaaS with parent progress tracking.", href: "https://kids.ahmedbahamat.com" },
      { title: "Tarsya AI", blurb: "AI agent for Saudi government tender proposals (Etimad).", href: "https://system.tarsya.net" },
      { title: "Alsawi", blurb: "Trainer–student courses, beta live." },
      { title: "Earab", blurb: "Leveled Arabic-grammar learning.", href: "https://earab.net" },
